  ...
  return (
    <div className="flex">
      <button
        className={
          isDarkTheme
            ? 'w-10 h-9 bg-zinc-900 flex justify-center items-center rounded-l-xl shadow-sm dark:shadow-black hover:bg-brand-500 hover:text-white transition-colors duration-300'
      ...
      <button
        className={
          isDarkTheme
            ? 'w-10 h-9 bg-brand-300 text-white flex justify-center items-center rounded-r-xl shadow-sm dark:shadow-black hover:bg-brand-500 hover:text-white transition-colors duration-300'
